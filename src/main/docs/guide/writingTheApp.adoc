As mentioned previously in this guide you are going to implement the Neo4j https://neo4j.com/developer/example-project/[Movies example application]. The Neo4j website describes the example as follows:
